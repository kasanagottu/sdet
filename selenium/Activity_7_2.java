...
public class Activity_7_2 {
    public static void main(String[] args) {
      ...
      //  WebElement userName = driver.findElement(By.xpath("//input[@name='name-1b49fae5-5c1a-7f16-59d1-fe011761578d']"));
        ...
        confirmPassword.sendKeys("Venkat");
        email.sendKeys("venkatl@xyz.com");
        //Click Sign Up
