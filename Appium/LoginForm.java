...
public class LoginForm {
    ...
    public void ALoginSucess() throws Exception  {
       ...
       //Wait
		...
		//driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).flingToEnd(3)"));
		...
		//MobileElement listitem = driver.findElementByXPath("//android.view.View[contains(@text,'Login Form')]");
		//listitem.click();
		Thread.sleep(5000);
		//Enter the User Name		
