...
public class GoogleKeepReminder {
	...
	public void CreateNote()  {
		...
		reminder=driver.findElementById("com.google.android.keep:id/text").getText(); 
		System.out.println("The reminder test is: "+reminder);
